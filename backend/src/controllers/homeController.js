...
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, game, character, gamesData, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), game = _a[0], character = _a[1];
                gamesData = game.map(function (games) {
                    var imageBuffer = Buffer.from(games.picture.buffer);
                    var base64Image = imageBuffer.toString('base64');
                    var imageDataURL = "data:image/jpeg;base64,".concat(base64Image);
                    return {
                        _id: games._id,
